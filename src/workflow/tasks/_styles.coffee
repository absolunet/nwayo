...
gulp.task 'styles_compile', ['styles_lint', 'styles_constants'], ->
	...
	for bname, bundle of ENV.bundles
		...
		for collection, list of bundle.styles.collections
			...
			fs.outputFileSync "#{PATH.dir.cacheStyles}/#{bname}/collections/#{collection}.scss", """
		...
		streams.push(
			sass "#{PATH.dir.cacheStyles}/#{bname}/collections/*.scss", {
...
gulp.task 'styles', (cb) ->
	...
	list = [PATH.dir.cacheInline, PATH.dir.cache_sass]
