...
util.path = ( ->
	...
	files.scripts_lint    = [files.bundles_scripts, files.scripts, "!#{dir.scripts_nolint}/**/*", "!#{dir.scripts}/**/vendor-*"]
	files.styles          = "#{dir.styles}/**/*.scss"
	files.styles_lint     = [files.bundles_styles, files.styles, "!#{dir.styles_nolint}/**/*", "!#{dir.styles}/**/vendor-*"]
