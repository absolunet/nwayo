 ...
 */
class ScriptsPlugin extends Plugin {
	...
	/**
	 * Setup default Babel configuration.
	 *
	 * @private
	 */
	_configureBabel() {
		this.nwayoApi.withLaravelMix((laravelMix) => {
			const browsersList = this.nwayoApi.get('.browserslistrc');

			const targets = browsersList ? fs.readFile(browsersList, 'utf8').split('\n').filter(Boolean) : undefined;
