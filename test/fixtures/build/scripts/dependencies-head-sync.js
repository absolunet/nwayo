/*!
 * @preserve Generated by nwayo 3.6.0-beta.2 for PROJECT_NAME:site
 */
	...
	(function () {
		...
		*/
		...
		(function (global, factory) {
			...
			//-- Main
			var pinki = function () {function pinki() {_classCallCheck(this, pinki);}_createClass(pinki, null, [{ key: 'Promise',
					...
					//-- Message
						...
						return function () {function _class() {_classCallCheck(this, _class);}_createClass(_class, null, [{ key: 'subscribe',
		
								//-- Subscribe to a topic
								value: function subscribe(topic, subscriber) {var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},_ref$executePrevious = _ref.executePrevious,executePrevious = _ref$executePrevious === undefined ? true : _ref$executePrevious;
									if (executePrevious) {
					...
					//-- Vow
						...
						return function () {function _class2() {_classCallCheck(this, _class2);}_createClass(_class2, null, [{ key: 'when',
