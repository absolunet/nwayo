/*!
 * @preserve Generated by nwayo 3.4.2 for PROJECT_NAME:site
 */
	...
	(function () {
		...
		*/
		...
		(function (global, factory) {
			...
			//-- Main
			var pinki = function () {function pinki() {_classCallCheck(this, pinki);}_createClass(pinki, null, [{ key: 'subscribe',
		
					//-- Map PubSub
					get: function get() {return PubSub.subscribe;} }, { key: 'publish', get: function get()
					{return PubSub.publish;} }, { key: 'unsubscribe', get: function get()
					{return PubSub.unsubscribe;}
		
					//-- Map RSVP
				}, { key: 'Promise', get: function get() {return RSVP.Promise;}
					...
					//-- Vow
						...
						return function () {function _class() {_classCallCheck(this, _class);}_createClass(_class, null, [{ key: 'when',
								...
								get: function get() {return Object.keys(vows);} }]);return _class;}();
